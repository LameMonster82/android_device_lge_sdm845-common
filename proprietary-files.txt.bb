...
# Display postrocessing - from Z01R - 100.04.44.98
vendor/bin/hw/vendor.display.color@1.0-service|de01dab653fee79fdec873069eb55bb54bb9fdfd
vendor/bin/mm-pp-dpps|042f294d0691d484b14b24fdc6f35ae1cc40e676
vendor/bin/ppd|97f8620ed9280e7b4122636c0364e73b42a522a6
...
vendor/lib64/vendor.lge.hardware.property@2.0.so
vendor/lib/hw/vendor.lge.hardware.property@2.0-impl.so
...
# Graphics (Adreno) - from Z01R - 100.04.44.98
...
# Graphics (Vulkan) - from Z01R - 100.04.44.98
vendor/lib/hw/vulkan.sdm845.so|66465cd7fa5290664dd63fff895e923c553c8793
...
# LGE Bootproperty
vendor/bin/hw/vendor.lge.hardware.bootproperty@1.0-service
vendor/etc/init/vendor.lge.hardware.bootproperty@1.0-service.rc
vendor/lib64/hw/vendor.lge.hardware.bootproperty@1.0-impl.so
vendor/lib64/vendor.lge.hardware.bootproperty@1.0.so
vendor/lib/hw/vendor.lge.hardware.bootproperty@1.0-impl.so
vendor/lib/vendor.lge.hardware.bootproperty@1.0.so

# LGE Platform
vendor/bin/hw/vendor.lge.hardware.platform@1.1-service
vendor/etc/init/vendor.lge.hardware.platform@1.1-service.rc
...
vendor/lib/vendor.lge.hardware.radio@1.3.so
...
vendor/lib64/vendor.lge.hardware.radio@1.3.so
...
# RIL - VSS
vendor/lib/libvss_common_idl.so
vendor/lib/libvss_common_iface.so
vendor/lib/libvss_dmi_qcci.so
vendor/lib/libvss_gnss_qcci.so
vendor/lib/libvss_ims_qcci.so
vendor/lib/libvss_nv_idl.so
vendor/lib/libvss_nv_iface.so
vendor/lib/libvss_resim_core.so
vendor/lib/libvss_resim_idl.so
vendor/lib/libvss_resim_iface.so
...
vendor/lib64/libvss_resim_core.so
...
vendor/lib/libvssims-impl.so
vendor/lib/hw/vendor.lge.hardware.vss_ims@1.0-impl.so
